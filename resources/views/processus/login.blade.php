  ...
  <!------------------
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="../dashboard.html">PROCE</a>
        </div>
                        ...
                        <form method="POST" action="{{ route('login') }}" >
                            ...
                            <div class="card card-login card-hidden">
                                ...
                                <div class="card-content">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input id="matricule" type="text" name="matricule" class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="footer text-center">
                                    <button type="submit" class="btn btn-rose btn-simple btn-wd btn-lg" style="color:green">CONNEXION</button>
